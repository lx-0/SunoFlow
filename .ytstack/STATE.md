...
**Status:** M005 / S01 — 2/5 tasks done (T01 schema, T02 host routes). Next: S01-T03 (guest state endpoint). M004 remains open on its user-side GATE (below); agent-side M004 work is blocked on that device pass.
