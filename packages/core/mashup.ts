...
// Mashup request contract — shared by the web route (server validation) and the
// mobile client. A track can be referenced by songId, fileUrl, or base64Data.
...
const trackSourceSchema = z
  ...
  .refine((track) => Boolean(track.base64Data || track.fileUrl || track.songId), {
