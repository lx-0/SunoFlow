...
export default function PublicPlaylistError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logError("error-boundary:p/[slug]", error);
  }, [error]);
  return (
    <div className="px-4 py-12 flex flex-col items-center text-center space-y-4">
      ...
      <p className="text-gray-500 dark:text-gray-400 text-sm">
        Something went wrong loading this playlist. It may not exist or there was a server error.
      </p>
